...
export function PricingPage() {
  ...
  const getPayments = async () => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/payments/all?page=${page}&limit=${limit}`, {
      method: "GET",
      headers: {
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="border rounded-md">
                        <QuillEditor id="description" value={field.value} onChange={(value) => field.onChange(value)} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Package Name</FormLabel>
                    <FormControl>
                      <Input placeholder={editingPlan?.name || "Enter package name"} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
      ...
      <Dialog open={isDeletePackageOpen} onOpenChange={setIsDeletePackageOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button type="button" className="bg-[#0a1172] hover:bg-[#1a2182]" onClick={handleDeletePlan}>
              Delete
            </Button>
          </DialogFooter>
        </DialogContent>
